    ...
    function (e, t) {
      function n(e) {
        ...
        for (t in a) this.config[t] = a[t];
          this.capabilities = r, i.call(this), n = this.connection = p.connect(this.config.url), n.on("connect", function () {
          ...
          }), n.on("solo", function (pt) {
            if(pt) write_alert("You have left your partner!");
            else write_alert("Your partner has left!");
            leaveWebRTC();
            resetBox("remote");
            notify(2);
            ...
            notify(0);
          }), n.on("newQuestion", function (tit, inf) {
            write_alert("A new challenge is ready!");
            write_question(tit, inf);
            notify(0);
          }), n.on("runStatus", function( me, result ) {
            var who, div;
            who = "remote";
            if(me) {who = "self";}
            div = "#" + who + "-result";
            show_result(who, div, result);
          }), n.on("updateCode", function (e) {
            remoteEdit.setValue(e);
          }), n.on("notif", function (msg) {
            write_alert(msg);
        ...
        n.prototype = Object.create(i.prototype, {
          ...
          n = e.videoEl;
          t.innerHTML = '';
          this.config.autoRemoveVideos && t && n, n && this.emit("videoRemoved", n, e)
        ...
        }, n.prototype.toggleQuestion = function () {
          this.connection.emit("getQuestion");
        }, n.prototype.toggleRoom = function () {
          this.connection.emit("toggleRoom");
        }, n.prototype.runCode = function (cd) {
          this.connection.emit("run", cd);
